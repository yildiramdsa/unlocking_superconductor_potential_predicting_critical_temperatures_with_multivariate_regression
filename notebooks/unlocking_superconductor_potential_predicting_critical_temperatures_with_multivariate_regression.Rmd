...
```{r}
ggplot(final_model, aes(x=.fitted, y=.resid)) + geom_point() + geom_smooth() +
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(wtd_mean_ElectronAffinity^2)+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(wtd_mean_ElectronAffinity^2)+I(wtd_mean_ElectronAffinity^3)
                 +wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(log(wtd_mean_ElectronAffinity))+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(range_atomic_radius^2)+I(range_atomic_radius^3)+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(range_atomic_radius^2)+I(range_atomic_radius^3)+I(range_atomic_radius^4)+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(range_atomic_radius^2)+I(range_atomic_radius^3)+I(wtd_entropy_fie^2)+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(range_atomic_radius^2)+I(range_atomic_radius^3)+I(wtd_entropy_fie^2)
                 +I(wtd_entropy_fie^3)+wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
                 +range_atomic_radius:wtd_entropy_Density
...
```{r}
final_model = lm(critical_temp ~ range_atomic_radius:wtd_mean_ThermalConductivity
                 +wtd_mean_ElectronAffinity+I(range_atomic_radius^2)+I(range_atomic_radius^3)+I(wtd_mean_atomic_radius^2)
                 +wtd_mean_atomic_radius+mean_atomic_mass
                 +wtd_mean_fie+wtd_entropy_ElectronAffinity+wtd_entropy_Density+wtd_mean_atomic_mass
                 +mean_ElectronAffinity+mean_Density+number_of_elements+wtd_entropy_fie
                 +range_atomic_radius+wtd_mean_ThermalConductivity+wtd_mean_fie:range_atomic_radius
